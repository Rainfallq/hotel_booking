...
class BookingSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Booking
        fields = ("id", "room", "room_detail", "check_in", "check_out", "status", "created_at")
    ...
    def validate(self, attrs: dict) -> dict:
        ...
        if self.instance:
            conflict_bookings = conflict_bookings.exclude(pk=self.instance.pk) # for put/patch operations
